...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 124, ; uint32_t number_of_assemblies_in_apk (0x7c)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 568, ; uint32_t number_of_dso_cache_entries (0x238)
	i32 33555156, ; uint32_t android_runtime_jnienv_class_token (0x20002d4)
	i32 100671006, ; uint32_t jnienv_initialize_method_token (0x6001e1e)
	i32 100671005, ; uint32_t jnienv_registerjninatives_method_token (0x6001e1d)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [568 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 3292724627449928134, ; hash 0x2db21b9a625559c6, from name: aot-ChronoTap.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 102
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3672395164100917079, ; hash 0x32f6f7f1cf18f757, from name: ChronoTap
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 4710707075886637547, ; hash 0x415fcb208b2461eb, from name: aot-ChronoTap
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 143
	...
	%struct.DSOCacheEntry {
		i64 5434364967562893758, ; hash 0x4b6abe253f69d9be, from name: ChronoTap.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 159
	...
	%struct.DSOCacheEntry {
		i64 6821502273828496333, ; hash 0x5eaad82d1a1123cd, from name: libaot-ChronoTap
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	...
	%struct.DSOCacheEntry {
		i64 12827835070173992284, ; hash 0xb205a0081304d55c, from name: libaot-ChronoTap.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 399
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0b701524-129e-4a03-a89a-190d65565af9\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.teftele.chronotap\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [24 x i8] c"libaot-ChronoTap.dll.so\00", align 16
