...
@dso_cache = dso_local local_unnamed_addr global [568 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 973779, ; hash 0xedbd3, from name: aot-ChronoTap.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1336787385, ; hash 0x4fadc1b9, from name: ChronoTap.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	...
	%struct.DSOCacheEntry {
		i64 1550619116, ; hash 0x5c6c91ec, from name: libaot-ChronoTap
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	...
	%struct.DSOCacheEntry {
		i64 1674145545, ; hash 0x63c96f09, from name: aot-ChronoTap
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 2016477049, ; hash 0x7830ff79, from name: ChronoTap
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 252
	...
	%struct.DSOCacheEntry {
		i64 4079618912, ; hash 0xf32a0b60, from name: libaot-ChronoTap.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ChronoTap.dll.so
		ptr null; void* handle (0x0)
	}, ; 539
